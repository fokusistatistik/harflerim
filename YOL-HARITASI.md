...
**Sürüm 2.9 · 13 Eylül 2026 — Mühürlenmiş**
...
| 1.7 | **Üç cihaz ölçeklemesi** ✅ *Tamamlandı (Header/ana sayfa/GameBoard)* | Akışkan tipografi (`clamp()`) ve dokunma hedefi (44px) tokenleri kuruldu; `lg:`/`xl:` kırılma noktaları Header, ana sayfa ve GameBoard'a uygulandı. *Hafıza Kartları/Sihirli Kelimeler'e tam yayılım henüz yapılmadı — 1.6 ile aynı "altyapı kuruldu, tam migrasyon değil" durumu.* | Orta |
| 1.8 | **Ortak oyun soyutlaması** ✅ *Tamamlandı (daraltılmış kapsam)* | Dört oyunun (Harf Avı, Hafıza Kartları, Sihirli Kelimeler, Görsel Eşleştirme) ilerleme modelleri yapısal olarak çok farklı olduğu için tek bir UI/seviye-merdiveni kabuğu yerine **ortak altyapı, ayrı arayüzler** seçildi: dördü de artık ortak bir mekanizmayla (`useGameDayBudget`) günlük süre bütçesine rapor veriyor ve `isDayComplete` olduğunda kilitleniyor. Visual Match'in bozuk ses dosyaları düzeltildi, 4. oyun olarak menüye eklendi. *Tam UI/seviye-merdiveni birleşimi ayrı bir loop'a bırakıldı.* | Yüksek |
