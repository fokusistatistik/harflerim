...
**İlerleme notu (2026-09-13)** — Python temel altyapısı (`papatya-python`, port 8030) + 3.1, 3.2, 3.2b, 3.3, 3.4, 3.5, 3.7 tamamlandı; özet [YOL-HARITASI-YAPILANLAR.md](YOL-HARITASI-YAPILANLAR.md)'de. Geri kalan madde her biri ayrı bir loop'ta, kendi kapsam/karar turuyla ele alınacak (Faz 1'in çok-loop'lu deseni).
