...
| 3.17 | **Konuşma pratiği: sesli komut + yaklaşık-eşleşme ödülü (öneri, 2026-09-15)** | Bazı bölümlerde (ör. Harf Avı, AAC) çocuğun sesle "komut vermesi" (dokunmak yerine/yanında hedefi söylemesi) desteklenip, söyleneni beklenen kelimeyle **yaklaşık eşleştiren** (tam telaffuz şartı aranmayan) bir tanıma katmanıyla bonus pekiştirme sunulması — mevcut `useVoiceConfirm` altyapısı (Aile Albümü'nde zaten sözlü onay için kullanılıyor) bu iş için teknik temel oluşturuyor, yeni bir mimari gerekmiyor. **Kritik tasarım şartı (AAC alanının yerleşik ilkesi):** Bu özellik hiçbir şekilde sözlü konuşmayı AAC/sözel-olmayan iletişime göre "üstün" veya "asıl hedef" gibi çerçevelemez — konuşmayan/sınırlı konuşan bir çocukta yanlış bir baskı yaratmamak için özellik **ebeveynin çocuk başına açıp kapatabileceği isteğe bağlı bir mod olmalı** (mevcut `communicationLevel` alanı iyi bir eşik noktası). Ödül **asla rastgele/değişken olmamalı** (YOL-HARITASI'nın anti-bağımlılık mimarisindeki "kumar mekaniği" yasağıyla tutarlı) — eşik karşılanınca her zaman aynı, öngörülebilir pekiştirme verilir. Yanlış/tanınmayan denemeler cezalandırılmaz, yalnızca dokunmatik yol her zaman birincil kalır. Faz 4 uzman denetim kapısından geçmeli. | Orta |
