...
export function ParentFooter() {
    ...
    return (
        <div className="fixed bottom-0 left-0 w-full h-12 z-50 backdrop-blur-md bg-white/80 border-t border-gray-200 flex items-center justify-between px-4 text-xs md:text-sm text-gray-500 font-sans shadow-lg">
            ...
            {/* Lock Icon */}
            <div className="ml-4 pl-4 border-l border-gray-300 opacity-50">
                <Lock size={16} />
            </div>
